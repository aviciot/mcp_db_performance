#!/usr/bin/env python3
"""
Update knowledge_db.py to support schema-aware queries
"""
...
server_dir = r"C:\Users\acohen.SHIFT4CORP\Desktop\PythonProjects\MCP Performance\server"
knowledge_db_path = os.path.join(server_dir, "knowledge_db.py")
